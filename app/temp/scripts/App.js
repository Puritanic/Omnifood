...
(0, _jquery2.default)(function () {
  ...
  (0, _jquery2.default)('#js-features-scroll').on('click', function () {
    (0, _jquery2.default)('html, body').animate({ scrollTop: (0, _jquery2.default)('#features').offset().top }, 1000);
  });
  (0, _jquery2.default)('#js-plans-scroll').on('click', function () {
    (0, _jquery2.default)('html, body').animate({ scrollTop: (0, _jquery2.default)('#plans').offset().top }, 1000);
  });
